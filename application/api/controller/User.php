...
use app\api\model\Company as OrgModel;
use app\api\model\UserCompany as UserOrgModel;
...
class User extends Api {
    ...
    public function company()
    {
        ...
        $user = UserModel::get($this->user['id'], 'UserCompany');
        $companylist=$user["user_company"];
        foreach($companylist as $k =>$v){
            $company=OrgModel::get($v['org_id']);
            $companylist[$k]['org_name']=$company['name'];
        }
